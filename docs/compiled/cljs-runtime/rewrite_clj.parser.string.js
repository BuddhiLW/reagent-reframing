...
if((c === "\n")){
var G__40470 = escape_QMARK_;
var G__40471 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__40470;
lines = G__40471;
continue;
} else {
buf.append(c);

var G__40472 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__40473 = lines;
escape_QMARK_ = G__40472;
lines = G__40473;
continue;
...
var G__40467 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__40467) : rewrite_clj.node.string_node.call(null,G__40467));
});
...
var G__40468 = cljs.core.re_pattern(regex);
var G__40469 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__40468,G__40469) : rewrite_clj.node.token_node.call(null,G__40468,G__40469));
});
