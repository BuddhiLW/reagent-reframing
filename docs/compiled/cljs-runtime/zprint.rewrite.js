...
var G__41648 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__41648;
continue;
} else {
var G__41649 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41649;
continue;
}
} else {
var G__41650 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__41650;
continue;
}
}
...
var G__41636 = zloc;
var G__41637 = (function (){var G__41638 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__41639 = zloc;
var G__41639__$1 = (((G__41639 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__41639) : rewrite_clj.zip.node.call(null,G__41639)));
if((G__41639__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__41639__$1) : zprint.zutil.edn_STAR_.call(null,G__41639__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__41638) : rewrite_clj.zip.root.call(null,G__41638));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__41636,G__41637) : rewrite_clj.zip.replace.call(null,G__41636,G__41637));
});
/**
...
var G__41660 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__41660;
continue;
}
break;
...
var G__41664 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__41665 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__41664;
out = G__41665;
continue;
} else {
...
var G__41669 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__41670 = cljs.core.next(new_loc);
var G__41671 = replaced_loc;
nloc = G__41669;
new_loc = G__41670;
last_loc = G__41671;
continue;
...
return zprint.rewrite.sort_val((function (){var G__41644 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__41644) : rewrite_clj.zip.down.call(null,G__41644));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__41646_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__41646_SHARP_) : rewrite_clj.zip.tag.call(null,p1__41646_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__41646_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__41646_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
