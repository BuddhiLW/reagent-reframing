...
var G__43981 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__43982 = (i_s + (1));
var G__43983 = (i_s_SINGLEQUOTE_ + (1));
v = G__43981;
i_s = G__43982;
i_s_SINGLEQUOTE_ = G__43983;
continue;
} else {
var G__43984 = v;
var G__43985 = (i_s + (1));
var G__43986 = i_s_SINGLEQUOTE_;
v = G__43984;
i_s = G__43985;
i_s_SINGLEQUOTE_ = G__43986;
continue;
...
var vec__43887 = day8.re_frame_10x.view.event.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(1),null);
...
if(cljs.core.truth_((function (){var and__4149__auto__ = search_str;
if(cljs.core.truth_(and__4149__auto__)){
var and__4149__auto____$1 = num_seen;
...
var vec__43896 = result;
var vec__43899 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43896,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43899,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43899,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43899,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43896,(1),null);
...
var start = (function (){var G__43903 = form_str__$1;
var G__43903__$1 = (((G__43903 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__43903));
if((G__43903__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__43903__$1);
}
})();
...
var end = (function (){var G__43904 = start;
var G__43904__$1 = (((G__43904 == null))?null:(length + G__43904));
if((G__43904__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__43904__$1);
}
})();
...
var vec__43915 = day8.re_frame_10x.view.event.find_bounds(form_str,new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(highlighted_form),new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431).cljs$core$IFn$_invoke$arity$1(highlighted_form));
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43915,(0),null);
var end_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43915,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.h_box,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4564__auto__ = (function day8$re_frame_10x$view$event$indent_block_$_iter__43936(s__43937){
return (new cljs.core.LazySeq(null,(function (){
var s__43937__$1 = s__43937;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__43937__$1);
if(temp__5735__auto__){
var s__43937__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43937__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__43937__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__43939 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__43938 = (0);
while(true){
if((i__43938 < size__4563__auto__)){
var num = cljs.core._nth(c__4562__auto__,i__43938);
cljs.core.chunk_append(b__43939,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.box,new cljs.core.Keyword(null,"width","width",-384071477),"12px",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"background-color","background-color",570434026),day8.re_frame_10x.common_styles.standard_background_color,new cljs.core.Keyword(null,"border-top","border-top",-158897573),(cljs.core.truth_(first_QMARK_)?day8.re_frame_10x.view.event.code_border:null),new cljs.core.Keyword(null,"border-left","border-left",-1150760178),day8.re_frame_10x.view.event.code_border], null),new cljs.core.Keyword(null,"child","child",623967545),""], null));

var G__43994 = (i__43938 + (1));
i__43938 = G__43994;
continue;
} else {
return true;
...
return iter__4564__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(indent_level));
})())], null);
});
...
return null;
});})(i__43947,id,first_QMARK_,frag,c__4562__auto__,size__4563__auto__,b__43948,s__43946__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__43947,id,first_QMARK_,frag,c__4562__auto__,size__4563__auto__,b__43948,s__43946__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43948),day8$re_frame_10x$view$event$event_fragments_$_iter__43945(cljs.core.chunk_rest(s__43946__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43948),null);
}
} else {
var frag = cljs.core.first(s__43946__$2);
return cljs.core.cons((function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__43946__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),frag], null));

return null;
});})(id,first_QMARK_,frag,s__43946__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__43946__$2,temp__5735__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),frag], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__43945(cljs.core.rest(s__43946__$2)));
}
} else {
return null;
}
...
return iter__4564__auto__(cljs.core.take.cljs$core$IFn$_invoke$arity$2(max_frags,fragments));
