...
var G__40827 = (function (){var G__40828 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40828) : f.call(null,G__40828));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__40827) : rewrite_clj.node.coerce.call(null,G__40827));
});
/**
...
var len__4771__auto___40908 = arguments.length;
var i__4772__auto___40909 = (0);
while(true){
if((i__4772__auto___40909 < len__4771__auto___40908)){
args__4777__auto__.push((arguments[i__4772__auto___40909]));

var G__40910 = (i__4772__auto___40909 + (1));
i__4772__auto___40909 = G__40910;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__40836_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__40836_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq40837){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40838,G__40839,seq40837__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__40867 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__40867) : str_fn.call(null,G__40867));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__40871 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__40871) : str_fn.call(null,G__40871));
})()):null)));
...
var G__40887 = rewrite_clj.zip.base.tag(zloc);
var G__40887__$1 = (((G__40887 instanceof cljs.core.Keyword))?G__40887.fqn:null);
switch (G__40887__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__40877_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40877_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__40878_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40878_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40887__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__40899 = rewrite_clj.zip.base.tag(zloc);
var G__40899__$1 = (((G__40899 instanceof cljs.core.Keyword))?G__40899.fqn:null);
switch (G__40899__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__40897_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__40897_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40899__$1)].join('')));
