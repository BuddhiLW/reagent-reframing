...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__38165){
var map__38166 = p__38165;
var map__38166__$1 = cljs.core.__destructure_map(map__38166);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38166__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38166__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38166__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38166__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__38168_38202 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__38169_38203 = null;
var count__38170_38204 = (0);
var i__38171_38205 = (0);
while(true){
if((i__38171_38205 < count__38170_38204)){
var vec__38182_38206 = chunk__38169_38203.cljs$core$IIndexed$_nth$arity$2(null,i__38171_38205);
var k_38207 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38182_38206,(0),null);
var cb_38208 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38182_38206,(1),null);
try{var G__38187_38209 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_38208.cljs$core$IFn$_invoke$arity$1 ? cb_38208.cljs$core$IFn$_invoke$arity$1(G__38187_38209) : cb_38208.call(null,G__38187_38209));
}catch (e38185){var e_38210 = e38185;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_38207,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_38210], 0));
}

var G__38211 = seq__38168_38202;
var G__38212 = chunk__38169_38203;
var G__38213 = count__38170_38204;
var G__38214 = (i__38171_38205 + (1));
seq__38168_38202 = G__38211;
chunk__38169_38203 = G__38212;
count__38170_38204 = G__38213;
i__38171_38205 = G__38214;
continue;
} else {
var temp__5735__auto___38215 = cljs.core.seq(seq__38168_38202);
if(temp__5735__auto___38215){
var seq__38168_38216__$1 = temp__5735__auto___38215;
if(cljs.core.chunked_seq_QMARK_(seq__38168_38216__$1)){
var c__4591__auto___38217 = cljs.core.chunk_first(seq__38168_38216__$1);
var G__38218 = cljs.core.chunk_rest(seq__38168_38216__$1);
var G__38219 = c__4591__auto___38217;
var G__38220 = cljs.core.count(c__4591__auto___38217);
var G__38221 = (0);
seq__38168_38202 = G__38218;
chunk__38169_38203 = G__38219;
count__38170_38204 = G__38220;
i__38171_38205 = G__38221;
continue;
} else {
var vec__38190_38222 = cljs.core.first(seq__38168_38216__$1);
var k_38223 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38190_38222,(0),null);
var cb_38224 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38190_38222,(1),null);
try{var G__38194_38225 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_38224.cljs$core$IFn$_invoke$arity$1 ? cb_38224.cljs$core$IFn$_invoke$arity$1(G__38194_38225) : cb_38224.call(null,G__38194_38225));
}catch (e38193){var e_38226 = e38193;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_38223,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_38226], 0));
}

var G__38227 = cljs.core.next(seq__38168_38216__$1);
var G__38228 = null;
var G__38229 = (0);
var G__38230 = (0);
seq__38168_38202 = G__38227;
chunk__38169_38203 = G__38228;
count__38170_38204 = G__38229;
i__38171_38205 = G__38230;
continue;
}
} else {
}
