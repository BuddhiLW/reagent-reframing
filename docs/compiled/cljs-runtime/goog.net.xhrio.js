...
goog.scope(function() {
  ...
  goog.net.XhrIo.prototype.send = function(url, opt_method, opt_content, opt_headers) {
    ...
    try {
      ...
      goog.log.fine(this.logger_, this.formatMsg_("Error opening Xhr: " + err$9.message));
    ...
    try {
      ...
      goog.log.fine(this.logger_, this.formatMsg_("Send error: " + err$10.message));
      this.error_(goog.net.ErrorCode.EXCEPTION, err$10);
    }
  };
