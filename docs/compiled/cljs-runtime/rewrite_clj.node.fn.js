...
var syms = (function (){var iter__4564__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__39992(s__39993){
...
var c__4562__auto__ = cljs.core.chunk_first(s__39993__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__39995 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__39994 = (0);
while(true){
if((i__39994 < size__4563__auto__)){
var i = cljs.core._nth(c__4562__auto__,i__39994);
...
cljs.core.chunk_append(b__39995,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__40119 = (i__39994 + (1));
i__39994 = G__40119;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__39995),rewrite_clj$node$fn$fn_walk_$_iter__39992(cljs.core.chunk_rest(s__39993__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__39995),null);
}
} else {
var i = cljs.core.first(s__39993__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__39992(cljs.core.rest(s__39993__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__39989_SHARP_){
var or__4160__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__39989_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4417__auto__,k40011,else__4418__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k40011,else__4418__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4437__auto__,p__40040){
var vec__40045 = p__40040;
var k__4438__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40045,(0),null);
var v__4439__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40045,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__40009){
var self__ = this;
var G__40009__$1 = this;
return (new cljs.core.RecordIter((0),G__40009__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this40012,other40013){
var self__ = this;
var this40012__$1 = this;
return (((!((other40013 == null)))) && ((this40012__$1.constructor === other40013.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40012__$1.children,other40013.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this40012__$1.__extmap,other40013.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4422__auto__,k__4423__auto__,G__40009){
var self__ = this;
var this__4422__auto____$1 = this;
var pred__40083 = cljs.core.keyword_identical_QMARK_;
var expr__40084 = k__4423__auto__;
if(cljs.core.truth_((pred__40083.cljs$core$IFn$_invoke$arity$2 ? pred__40083.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__40084) : pred__40083.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__40084)))){
return (new rewrite_clj.node.fn.FnNode(G__40009,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4423__auto__,G__40009),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4414__auto__,G__40009){
var self__ = this;
var this__4414__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__40009,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__40015){
var extmap__4454__auto__ = (function (){var G__40097 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__40015,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__40015)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__40097);
} else {
return G__40097;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__40015),null,cljs.core.not_empty(extmap__4454__auto__),null));
});
