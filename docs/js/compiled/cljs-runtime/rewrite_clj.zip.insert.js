...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(insert_fn,zloc,(cljs.core.truth_((function (){var or__4160__auto__ = cljs.core.not(next_node);
if(or__4160__auto__){
...
return rewrite_clj.zip.insert.insert((function (p1__40779_SHARP_){
var G__40780 = p1__40779_SHARP_;
var G__40780__$1 = (((G__40780 == null))?null:clojure.zip.down(G__40780));
if((G__40780__$1 == null)){
return null;
} else {
return clojure.zip.rightmost(G__40780__$1);
}
