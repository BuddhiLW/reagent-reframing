...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4564__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__43268(s__43269){
return (new cljs.core.LazySeq(null,(function (){
var s__43269__$1 = s__43269;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__43269__$1);
if(temp__5735__auto__){
var s__43269__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__43269__$2)){
var c__4562__auto__ = cljs.core.chunk_first(s__43269__$2);
var size__4563__auto__ = cljs.core.count(c__4562__auto__);
var b__43271 = cljs.core.chunk_buffer(size__4563__auto__);
if((function (){var i__43270 = (0);
while(true){
if((i__43270 < size__4563__auto__)){
var vec__43272 = cljs.core._nth(c__4562__auto__,i__43270);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43272,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43272,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__43271,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__43279 = (i__43270 + (1));
i__43270 = G__43279;
continue;
} else {
var G__43280 = (i__43270 + (1));
i__43270 = G__43280;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__43271),day8$re_frame_10x$view$history$render_$_iter__43268(cljs.core.chunk_rest(s__43269__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__43271),null);
}
} else {
var vec__43275 = cljs.core.first(s__43269__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43275,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43275,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__43268(cljs.core.rest(s__43269__$2)));
} else {
var G__43281 = cljs.core.rest(s__43269__$2);
s__43269__$1 = G__43281;
continue;
}
}
} else {
...
return iter__4564__auto__(all_events);
})()], null)], null);
});
