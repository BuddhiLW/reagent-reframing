...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__43040_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__43040_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__43040_SHARP_) <= ending)));
}));
});
...
var G__43095 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__43095__$1 = (((G__43095 instanceof cljs.core.Keyword))?G__43095.fqn:null);
switch (G__43095__$1) {
...
var and__4149__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(sub,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("sub","traits","sub/traits",1778340671),new cljs.core.Keyword(null,"unchanged?","unchanged?",1212001763)], null));
if(cljs.core.truth_(and__4149__auto__)){
return ((cljs.core.not_any_QMARK_((function (p1__43118_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__43118_SHARP_);
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__43216_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__43216_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__43233){
var vec__43234 = p__43233;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43234,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43234,(1),null);
...
var new_state = (function (){var G__43238 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__43238__$1 = (((G__43238 instanceof cljs.core.Keyword))?G__43238.fqn:null);
switch (G__43238__$1) {
case "sub/create":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43238__$1)].join('')));
...
var second_pass = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (all_state,p__43240){
var vec__43241 = p__43240;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43241,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43241,(1),null);
