...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__51446){
...
return clojure.zip.zipper((function (p1__51451_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__51451_SHARP_)) || (cljs.core.map_QMARK_(p1__51451_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__51454){
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51468_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51468_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51467_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51467_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51473_SHARP_){
return (((p1__51473_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51473_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__51489,mapping){
var map__51490 = p__51489;
var map__51490__$1 = cljs.core.__destructure_map(map__51490);
var state = map__51490__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51490__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51490__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51490__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51485_SHARP_){
if((p1__51485_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51485_SHARP_);
} else {
return false;
}
}),day8.re_frame.debux.common.util.form_tree_seq(form)));
...
var G__51718 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__51723 = clojure.zip.next(loc);
loc = G__51723;
continue;
}
}
...
var len__4771__auto___51746 = arguments.length;
var i__4772__auto___51747 = (0);
while(true){
if((i__4772__auto___51747 < len__4771__auto___51746)){
args__4777__auto__.push((arguments[i__4772__auto___51747]));

var G__51748 = (i__4772__auto___51747 + (1));
i__4772__auto___51747 = G__51748;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__51568){
var vec__51569 = p__51568;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51569,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq51551){
var G__51552 = cljs.core.first(seq51551);
var seq51551__$1 = cljs.core.next(seq51551);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51552,seq51551__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51581_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51581_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__51590_51757 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51591_51758 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51592_51759 = true;
var _STAR_print_fn_STAR__temp_val__51593_51760 = (function (x__4703__auto__){
return sb__4702__auto__.append(x__4703__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51592_51759);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51593_51760);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51591_51758);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51590_51757);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4702__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__51589_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__51589_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__51775 = cljs.core.next(opts__$1);
var G__51776 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51775;
acc = G__51776;
continue;
} else {
if(typeof f === 'string'){
var G__51778 = cljs.core.next(opts__$1);
var G__51779 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51778;
acc = G__51779;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51780 = cljs.core.nnext(opts__$1);
var G__51781 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51780;
acc = G__51781;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51783 = cljs.core.next(opts__$1);
var G__51784 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51783;
acc = G__51784;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51605 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__51605.cljs$core$IFn$_invoke$arity$1 ? fexpr__51605.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51605.call(null,f));
})())){
var G__51786 = cljs.core.next(opts__$1);
var G__51787 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51786;
acc = G__51787;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__51606 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__51606.cljs$core$IFn$_invoke$arity$1 ? fexpr__51606.cljs$core$IFn$_invoke$arity$1(f) : fexpr__51606.call(null,f));
})())){
var G__51788 = cljs.core.nnext(opts__$1);
var G__51789 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51788;
acc = G__51789;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__51792 = cljs.core.next(opts__$1);
var G__51793 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51792;
acc = G__51793;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__51611){
...
var G__51628 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__51627 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__51627.cljs$core$IFn$_invoke$arity$1 ? fexpr__51627.cljs$core$IFn$_invoke$arity$1(G__51628) : fexpr__51627.call(null,G__51628));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51636 = quoted_form;
var G__51637 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51636,G__51637) : day8.re_frame.debux.common.util.remove_d.call(null,G__51636,G__51637));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51639 = quoted_form;
var G__51640 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51639,G__51640) : day8.re_frame.debux.common.util.remove_d.call(null,G__51639,G__51640));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51818__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51645 = quoted_form;
var G__51646 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51645,G__51646) : day8.re_frame.debux.common.util.remove_d.call(null,G__51645,G__51646));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__51835__i < G__51835__a.length) {G__51835__a[G__51835__i] = arguments[G__51835__i + 0]; ++G__51835__i;}
  arg = new cljs.core.IndexedSeq(G__51835__a,0,null);
} 
return G__51818__delegate.call(this,arg);};
G__51818.cljs$lang$maxFixedArity = 0;
G__51818.cljs$lang$applyTo = (function (arglist__51836){
var arg = cljs.core.seq(arglist__51836);
return G__51818__delegate(arg);
});
...
var G__51840 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51840;
continue;
} else {
...
var G__51842 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51842;
continue;
} else {
var G__51844 = clojure.zip.next(loc);
loc = G__51844;
continue;
