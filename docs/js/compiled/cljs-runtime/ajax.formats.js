...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__37226){
var map__37227 = p__37226;
var map__37227__$1 = cljs.core.__destructure_map(map__37227);
var request = map__37227__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37227__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__37231 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37231.cljs$core$IFn$_invoke$arity$1 ? fexpr__37231.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37231.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__37232 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__37232.cljs$core$IFn$_invoke$arity$1 ? fexpr__37232.cljs$core$IFn$_invoke$arity$1(response) : fexpr__37232.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__37233){
var map__37234 = p__37233;
var map__37234__$1 = cljs.core.__destructure_map(map__37234);
var request = map__37234__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37234__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
