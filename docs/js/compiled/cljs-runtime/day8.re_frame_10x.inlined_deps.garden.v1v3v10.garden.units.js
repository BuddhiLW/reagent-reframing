 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__36641,right){
var map__36642 = p__36641;
var map__36642__$1 = cljs.core.__destructure_map(map__36642);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36642__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36642__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__36643 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36643,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36643,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36643,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36648__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__36649 = u(y);
var map__36649__$1 = cljs.core.__destructure_map(map__36649);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36649__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__36751__delegate = function (x,y,more){
...
var G__36752__i = 0, G__36752__a = new Array(arguments.length -  2);
while (G__36752__i < G__36752__a.length) {G__36752__a[G__36752__i] = arguments[G__36752__i + 2]; ++G__36752__i;}
  more = new cljs.core.IndexedSeq(G__36752__a,0,null);
} 
...
var y = cljs.core.first(arglist__36753);
var more = cljs.core.rest(arglist__36753);
...
var G__36755 = null;
if (arguments.length > 2) {
var G__36756__i = 0, G__36756__a = new Array(arguments.length -  2);
while (G__36756__i < G__36756__a.length) {G__36756__a[G__36756__i] = arguments[G__36756__i + 2]; ++G__36756__i;}
G__36755 = new cljs.core.IndexedSeq(G__36756__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__36755);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36650__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__36651 = u(y);
var map__36651__$1 = cljs.core.__destructure_map(map__36651);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36651__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__36761__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__36762__i = 0, G__36762__a = new Array(arguments.length -  2);
while (G__36762__i < G__36762__a.length) {G__36762__a[G__36762__i] = arguments[G__36762__i + 2]; ++G__36762__i;}
  more = new cljs.core.IndexedSeq(G__36762__a,0,null);
} 
...
var y = cljs.core.first(arglist__36763);
var more = cljs.core.rest(arglist__36763);
...
var G__36765 = null;
if (arguments.length > 2) {
var G__36766__i = 0, G__36766__a = new Array(arguments.length -  2);
while (G__36766__i < G__36766__a.length) {G__36766__a[G__36766__i] = arguments[G__36766__i + 2]; ++G__36766__i;}
G__36765 = new cljs.core.IndexedSeq(G__36766__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__36765);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36656__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__36657 = u(y);
var map__36657__$1 = cljs.core.__destructure_map(map__36657);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36657__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var more = null;
if (arguments.length > 2) {
var G__36773__i = 0, G__36773__a = new Array(arguments.length -  2);
while (G__36773__i < G__36773__a.length) {G__36773__a[G__36773__i] = arguments[G__36773__i + 2]; ++G__36773__i;}
  more = new cljs.core.IndexedSeq(G__36773__a,0,null);
} 
return G__36772__delegate.call(this,x,y,more);};
G__36772.cljs$lang$maxFixedArity = 2;
G__36772.cljs$lang$applyTo = (function (arglist__36774){
...
var G__36776 = null;
if (arguments.length > 2) {
var G__36777__i = 0, G__36777__a = new Array(arguments.length -  2);
while (G__36777__i < G__36777__a.length) {G__36777__a[G__36777__i] = arguments[G__36777__i + 2]; ++G__36777__i;}
G__36776 = new cljs.core.IndexedSeq(G__36777__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__36776);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36665__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__36666 = u(y);
var map__36666__$1 = cljs.core.__destructure_map(map__36666);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36666__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__36779__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__36780__i = 0, G__36780__a = new Array(arguments.length -  2);
while (G__36780__i < G__36780__a.length) {G__36780__a[G__36780__i] = arguments[G__36780__i + 2]; ++G__36780__i;}
  more = new cljs.core.IndexedSeq(G__36780__a,0,null);
} 
return G__36779__delegate.call(this,x,y,more);};
G__36779.cljs$lang$maxFixedArity = 2;
G__36779.cljs$lang$applyTo = (function (arglist__36786){
var x = cljs.core.first(arglist__36786);
arglist__36786 = cljs.core.next(arglist__36786);
var y = cljs.core.first(arglist__36786);
var more = cljs.core.rest(arglist__36786);
...
var G__36787 = null;
if (arguments.length > 2) {
var G__36788__i = 0, G__36788__a = new Array(arguments.length -  2);
while (G__36788__i < G__36788__a.length) {G__36788__a[G__36788__i] = arguments[G__36788__i + 2]; ++G__36788__i;}
G__36787 = new cljs.core.IndexedSeq(G__36788__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__36787);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
