...
var len__4771__auto___32154 = arguments.length;
var i__4772__auto___32155 = (0);
while(true){
if((i__4772__auto___32155 < len__4771__auto___32154)){
args__4777__auto__.push((arguments[i__4772__auto___32155]));

var G__32156 = (i__4772__auto___32155 + (1));
i__4772__auto___32155 = G__32156;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32058){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32059,G__32060,seq32058__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32073_SHARP_){
return (!((cljs.core.meta(p1__32073_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32091__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32094){var _e__31383__auto__ = e32094;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e32120){var _e__31383__auto__ = e32120;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32125 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32126 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32126);

try{var map__32129 = opts;
var map__32129__$1 = cljs.core.__destructure_map(map__32129);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32129__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32125);
}});
...
var temp__5733__auto___32176 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___32176)){
var managed_print_level_32177 = temp__5733__auto___32176;
var _STAR_print_level_STAR__orig_val__32138_32178 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32139_32179 = managed_print_level_32177;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32139_32179);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__32136_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__32136_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32138_32178);
}} else {
job_fn();
}
