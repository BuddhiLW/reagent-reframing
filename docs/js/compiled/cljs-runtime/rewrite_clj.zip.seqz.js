...
var G__40923 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__40923__$1 = (((G__40923 == null))?null:cljs.core.iterate((function (loc){
...
var G__40923__$2 = (((G__40923__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__40923__$1));
var G__40923__$3 = (((G__40923__$2 == null))?null:cljs.core.last(G__40923__$2));
if((G__40923__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__40923__$3);
}
} else {
return zloc;
}
...
var parent = zloc;
while(true){
if(cljs.core.not((function (){var and__4149__auto__ = loc;
...
var G__40971 = rewrite_clj.zip.move.right(v);
var G__40972 = rewrite_clj.zip.move.up(v);
loc = G__40971;
parent = G__40972;
continue;
} else {
var G__40973 = rewrite_clj.zip.move.right(v0);
var G__40974 = parent;
loc = G__40973;
parent = G__40974;
continue;
...
var G__40980 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__40981 = rewrite_clj.zip.move.up(v);
loc = G__40980;
parent = G__40981;
continue;
} else {
var G__40982 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__40983 = parent;
loc = G__40982;
parent = G__40983;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__40956 = zloc;
var G__40956__$1 = (((G__40956 == null))?null:rewrite_clj.zip.move.down(G__40956));
var G__40956__$2 = (((G__40956__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__40956__$1,k));
if((G__40956__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__40956__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__40957 = rewrite_clj.zip.move.down(zloc);
var G__40957__$1 = (((G__40957 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__40957));
if((G__40957__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__40957__$1);
}
})(),k);
}
});
