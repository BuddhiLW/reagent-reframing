...
var G__39375 = new_next_nonws_QMARK_;
index = G__39373;
skip_to_right_QMARK_ = G__39374;
next_nonws_QMARK_ = G__39375;
continue;
}
}
break;
...
var G__39377 = zprint.focus.next_ssv(ssv,index);
var G__39378 = (moves - (1));
index = G__39377;
moves = G__39378;
continue;
}
...
var G__39379 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__39380 = cljs.core.next(nwp);
idx = G__39379;
nwp = G__39380;
continue;
}
...
var end = (cljs.core.truth_((function (){var and__4149__auto__ = ssv_next;
if(cljs.core.truth_(and__4149__auto__)){
