...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__40654,k,f){
var vec__40655 = p__40654;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40655,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40655,(1),null);
var loc = vec__40655;
...
var G__40732 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__40732;
continue;
}
break;
...
var G__40733 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__40733;
continue;
} else {
return zloc__$1;
...
var G__40735 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__40735;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__40691){
var vec__40692 = p__40691;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40692,(0),null);
var map__40695 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40692,(1),null);
var map__40695__$1 = cljs.core.__destructure_map(map__40695);
var path = map__40695__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40695__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__40692;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__40706){
...
var vec__40720 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40720,(0),null);
var map__40723 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40720,(1),null);
var map__40723__$1 = cljs.core.__destructure_map(map__40723);
var path = map__40723__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40723__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
