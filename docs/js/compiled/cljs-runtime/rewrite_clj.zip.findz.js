...
var len__4771__auto___40900 = arguments.length;
var i__4772__auto___40901 = (0);
while(true){
if((i__4772__auto___40901 < len__4771__auto___40900)){
args__4777__auto__.push((arguments[i__4772__auto___40901]));

var G__40902 = (i__4772__auto___40901 + (1));
i__4772__auto___40901 = G__40902;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__40804){
var vec__40805 = p__40804;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40805,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40799_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq40800){
var G__40801 = cljs.core.first(seq40800);
var seq40800__$1 = cljs.core.next(seq40800);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40801,seq40800__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__40810,p__40811){
var map__40812 = p__40810;
var map__40812__$1 = cljs.core.__destructure_map(map__40812);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40812__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40812__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40812__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40812__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__40813 = p__40811;
var map__40813__$1 = cljs.core.__destructure_map(map__40813);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40813__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40813__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
if((r >= row)){
if((r <= end_row)){
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40816_SHARP_){
var and__4149__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__40816_SHARP_) : p_QMARK_.call(null,p1__40816_SHARP_));
if(cljs.core.truth_(and__4149__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__40816_SHARP_)),pos);
} else {
...
var G__40821 = zloc;
var G__40821__$1 = (((G__40821 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40821) : f.call(null,G__40821)));
if((G__40821__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__40821__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__40822_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40822_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__40854_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__40854_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__40882_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__40882_SHARP_),v);
}));
