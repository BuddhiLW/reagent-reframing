...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__39381_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__39381_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__39381_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__39382){
var vec__39384 = p__39382;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39384,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39384,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__39387,s,color,element,idx){
var map__39388 = p__39387;
var map__39388__$1 = cljs.core.__destructure_map(map__39388);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39388__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39388__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39388__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__39393 = (function (){var or__4160__auto__ = color;
...
var fexpr__39392 = (function (){var G__39394 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
:(cljs.core.truth_((function (){var and__4149__auto__ = focus;
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__39394) : style_map.call(null,G__39394));
})();
return (fexpr__39392.cljs$core$IFn$_invoke$arity$1 ? fexpr__39392.cljs$core$IFn$_invoke$arity$1(G__39393) : fexpr__39392.call(null,G__39393));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__39395){
var vec__39396 = p__39395;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39396,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__39400){
var vec__39401 = p__39400;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39401,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39401,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39401,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__4160__auto__ = last_elide;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
var G__39573 = cljs.core.next(ssv);
var G__39574 = (this_ssv == null);
var G__39575 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__39576 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__39573;
doing_nil_QMARK_ = G__39574;
last_elide = G__39575;
out = G__39576;
continue;
}
...
var vec__39419 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39419,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39419,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39419,(2),null);
...
var G__39577 = cljs.core.next(remaining_cvec);
var G__39578 = new_idx;
var G__39579 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__39577;
idx = G__39578;
out = G__39579;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__39457,cursor_vec){
var vec__39460 = p__39457;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39460,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39460,(1),null);
var focus_vec = vec__39460;
...
var vec__39465 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39465,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39465,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__39477){
var vec__39478 = p__39477;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39478,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39478,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__39501,existing_count){
var vec__39502 = p__39501;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39502,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39502,(1),null);
...
var cursor__$1 = (function (){var x__4252__auto__ = zprint.finish.floor((0),(len - (1)));
var y__4253__auto__ = cursor;
return ((x__4252__auto__ < y__4253__auto__) ? x__4252__auto__ : y__4253__auto__);
})();
return cljs.core.filterv((function (p1__39492_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__39492_SHARP_))));
...
var vec__39527 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39527,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39527,(1),null);
var cvec_element = vec__39527;
if((cvec_element == null)){
var G__39629 = cljs.core.next(cvec_nl);
var G__39630 = (idx + (1));
var G__39631 = start;
var G__39632 = out;
cvec_nl = G__39629;
...
var G__39633 = cljs.core.next(cvec_nl);
var G__39634 = (idx + (1));
var G__39635 = idx;
var G__39636 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__39633;
idx = G__39634;
start = G__39635;
out = G__39636;
...
var G__39638 = cljs.core.next(cvec_nl);
var G__39639 = (idx + (1));
var G__39640 = (idx + (1));
var G__39641 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__39638;
idx = G__39639;
start = G__39640;
out = G__39641;
...
if(cljs.core.truth_((((n > (1)))?(function (){var and__4149__auto__ = new cljs.core.Keyword(null,"b","b",1482224470).cljs$core$IFn$_invoke$arity$1(where);
if(cljs.core.truth_(and__4149__auto__)){
...
var G__39642 = cljs.core.next(cvec_nl);
var G__39643 = (idx + (1));
var G__39644 = idx;
var G__39645 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__39642;
idx = G__39643;
start = G__39644;
out = G__39645;
...
var G__39646 = cljs.core.next(cvec_nl);
var G__39647 = (idx + (1));
var G__39648 = start;
var G__39649 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__39646;
idx = G__39647;
start = G__39648;
out = G__39649;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__39535_SHARP_,p2__39534_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__39534_SHARP_)){
return cljs.core.reduced(p1__39535_SHARP_);
} else {
return (p1__39535_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__39538,p__39539){
var vec__39540 = p__39538;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39540,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39540,(1),null);
var vec__39543 = p__39539;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39543,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39543,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__39559,cvec,focus_vec){
var map__39560 = p__39559;
var map__39560__$1 = cljs.core.__destructure_map(map__39560);
var options = map__39560__$1;
var map__39561 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39560__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__39561__$1 = cljs.core.__destructure_map(map__39561);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39561__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39561__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39561__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if(cljs.core.truth_((function (){var or__4160__auto__ = lines;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
var or__4160__auto____$1 = paths;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39555_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__39555_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
