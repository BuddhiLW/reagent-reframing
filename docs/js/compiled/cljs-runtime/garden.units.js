 ...
 */
garden.units.convert = (function garden$units$convert(p__52956,right){
var map__52957 = p__52956;
var map__52957__$1 = cljs.core.__destructure_map(map__52957);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52957__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52957__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__52974 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52974,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52974,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52974,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52994__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__52995 = u(y);
var map__52995__$1 = cljs.core.__destructure_map(map__52995);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52995__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__53088__delegate = function (x,y,more){
...
var G__53088 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__53089__i = 0, G__53089__a = new Array(arguments.length -  2);
while (G__53089__i < G__53089__a.length) {G__53089__a[G__53089__i] = arguments[G__53089__i + 2]; ++G__53089__i;}
  more = new cljs.core.IndexedSeq(G__53089__a,0,null);
} 
return G__53088__delegate.call(this,x,y,more);};
G__53088.cljs$lang$maxFixedArity = 2;
G__53088.cljs$lang$applyTo = (function (arglist__53090){
...
return G__53088__delegate(x,y,more);
});
...
var G__53091 = null;
if (arguments.length > 2) {
var G__53092__i = 0, G__53092__a = new Array(arguments.length -  2);
while (G__53092__i < G__53092__a.length) {G__53092__a[G__53092__i] = arguments[G__53092__i + 2]; ++G__53092__i;}
G__53091 = new cljs.core.IndexedSeq(G__53092__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53091);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52998__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__52999 = u(y);
var map__52999__$1 = cljs.core.__destructure_map(map__52999);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52999__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__53093__delegate = function (x,y,more){
...
var G__53093 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__53094__i = 0, G__53094__a = new Array(arguments.length -  2);
while (G__53094__i < G__53094__a.length) {G__53094__a[G__53094__i] = arguments[G__53094__i + 2]; ++G__53094__i;}
  more = new cljs.core.IndexedSeq(G__53094__a,0,null);
} 
return G__53093__delegate.call(this,x,y,more);};
G__53093.cljs$lang$maxFixedArity = 2;
G__53093.cljs$lang$applyTo = (function (arglist__53095){
var x = cljs.core.first(arglist__53095);
arglist__53095 = cljs.core.next(arglist__53095);
var y = cljs.core.first(arglist__53095);
var more = cljs.core.rest(arglist__53095);
return G__53093__delegate(x,y,more);
});
G__53093.cljs$core$IFn$_invoke$arity$variadic = G__53093__delegate;
return G__53093;
})()
;
...
var G__53096 = null;
if (arguments.length > 2) {
var G__53097__i = 0, G__53097__a = new Array(arguments.length -  2);
while (G__53097__i < G__53097__a.length) {G__53097__a[G__53097__i] = arguments[G__53097__i + 2]; ++G__53097__i;}
G__53096 = new cljs.core.IndexedSeq(G__53097__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53096);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53008__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__53009 = u(y);
var map__53009__$1 = cljs.core.__destructure_map(map__53009);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53009__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__53098__delegate = function (x,y,more){
...
var G__53098 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__53099__i = 0, G__53099__a = new Array(arguments.length -  2);
while (G__53099__i < G__53099__a.length) {G__53099__a[G__53099__i] = arguments[G__53099__i + 2]; ++G__53099__i;}
  more = new cljs.core.IndexedSeq(G__53099__a,0,null);
} 
return G__53098__delegate.call(this,x,y,more);};
G__53098.cljs$lang$maxFixedArity = 2;
G__53098.cljs$lang$applyTo = (function (arglist__53100){
var x = cljs.core.first(arglist__53100);
arglist__53100 = cljs.core.next(arglist__53100);
var y = cljs.core.first(arglist__53100);
var more = cljs.core.rest(arglist__53100);
return G__53098__delegate(x,y,more);
});
G__53098.cljs$core$IFn$_invoke$arity$variadic = G__53098__delegate;
return G__53098;
})()
;
...
var G__53101 = null;
if (arguments.length > 2) {
var G__53102__i = 0, G__53102__a = new Array(arguments.length -  2);
while (G__53102__i < G__53102__a.length) {G__53102__a[G__53102__i] = arguments[G__53102__i + 2]; ++G__53102__i;}
G__53101 = new cljs.core.IndexedSeq(G__53102__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53101);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53017__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__53018 = u(y);
var map__53018__$1 = cljs.core.__destructure_map(map__53018);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53018__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__53108__delegate = function (x,y,more){
...
var G__53108 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__53111__i = 0, G__53111__a = new Array(arguments.length -  2);
while (G__53111__i < G__53111__a.length) {G__53111__a[G__53111__i] = arguments[G__53111__i + 2]; ++G__53111__i;}
  more = new cljs.core.IndexedSeq(G__53111__a,0,null);
} 
return G__53108__delegate.call(this,x,y,more);};
G__53108.cljs$lang$maxFixedArity = 2;
G__53108.cljs$lang$applyTo = (function (arglist__53112){
var x = cljs.core.first(arglist__53112);
arglist__53112 = cljs.core.next(arglist__53112);
var y = cljs.core.first(arglist__53112);
var more = cljs.core.rest(arglist__53112);
return G__53108__delegate(x,y,more);
});
...
var G__53114 = null;
if (arguments.length > 2) {
var G__53115__i = 0, G__53115__a = new Array(arguments.length -  2);
while (G__53115__i < G__53115__a.length) {G__53115__a[G__53115__i] = arguments[G__53115__i + 2]; ++G__53115__i;}
G__53114 = new cljs.core.IndexedSeq(G__53115__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53114);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
