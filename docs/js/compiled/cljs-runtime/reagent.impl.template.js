...
var G__39150 = o;
goog.object.set(G__39150,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__39151 = o;
goog.object.set(G__39151,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__39198__i < G__39198__a.length) {G__39198__a[G__39198__i] = arguments[G__39198__i + 0]; ++G__39198__i;}
  args = new cljs.core.IndexedSeq(G__39198__a,0,null);
} 
...
var G__39152 = props;
var G__39152__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39152,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39152);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39152__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39153 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39153,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39153;
}
})(),id_class);
...
var G__39154 = (cljs.core.count(argv) - first_child);
switch (G__39154) {
case (0):
...
var vec__39158 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39158,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39158,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39158,(2),null);
...
var temp__5739__auto___39222 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39222 == null)){
} else {
var key_39227 = temp__5739__auto___39222;
(jsprops.key = key_39227);
}
...
var temp__5739__auto___39228 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39228 == null)){
} else {
var key_39233 = temp__5739__auto___39228;
(jsprops.key = key_39233);
}
...
var temp__5739__auto___39237 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39237 == null)){
} else {
var key_39238 = temp__5739__auto___39237;
(jsprops.key = key_39238);
}
...
var temp__5739__auto___39249 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39249 == null)){
} else {
var key_39250 = temp__5739__auto___39249;
(jsprops.key = key_39250);
}
...
var temp__5739__auto___39251 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39251 == null)){
} else {
var key_39252 = temp__5739__auto___39251;
(jsprops.key = key_39252);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39175_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39175_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39179 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39179,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39179,(1),null);
...
break;
default:
var G__39255 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39256 = compiler;
v = G__39255;
compiler = G__39256;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39186 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39186 = (function (opts,id,fn_to_element,meta39187){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39186.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39188,meta39187__$1){
var self__ = this;
var _39188__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39186(self__.opts,self__.id,self__.fn_to_element,meta39187__$1));
}));

(reagent.impl.template.t_reagent$impl$template39186.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39188){
var self__ = this;
var _39188__$1 = this;
return self__.meta39187;
}));

(reagent.impl.template.t_reagent$impl$template39186.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39186.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39186.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39186.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39186.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta39187","meta39187",31163508,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39186.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39186.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39186");

(reagent.impl.template.t_reagent$impl$template39186.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write(writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template39186");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39186.
 */
reagent.impl.template.__GT_t_reagent$impl$template39186 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39186(opts__$1,id__$1,fn_to_element__$1,meta39187){
return (new reagent.impl.template.t_reagent$impl$template39186(opts__$1,id__$1,fn_to_element__$1,meta39187));
});

}

return (new reagent.impl.template.t_reagent$impl$template39186(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
