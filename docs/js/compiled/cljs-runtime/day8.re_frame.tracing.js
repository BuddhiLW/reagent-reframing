...
var G__52873 = clojure.zip.next(loc);
var G__52874 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node);
loc = G__52873;
seen = G__52874;
continue;
} else {
var G__52875 = clojure.zip.next(loc);
var G__52876 = seen;
loc = G__52875;
seen = G__52876;
continue;
...
var len__4771__auto___52877 = arguments.length;
var i__4772__auto___52878 = (0);
while(true){
if((i__4772__auto___52878 < len__4771__auto___52877)){
args__4777__auto__.push((arguments[i__4772__auto___52878]));

var G__52879 = (i__4772__auto___52878 + (1));
i__4772__auto___52878 = G__52879;
continue;
} else {
}
break;
...
return day8.re_frame.tracing.fn_body.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4778__auto__);
});

(day8.re_frame.tracing.fn_body.cljs$core$IFn$_invoke$arity$variadic = (function (args_PLUS_body,send_form){
var args = (function (){var or__4160__auto__ = new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(args_PLUS_body));
...
/** @this {Function} */
(day8.re_frame.tracing.fn_body.cljs$lang$applyTo = (function (seq52853){
var G__52854 = cljs.core.first(seq52853);
var seq52853__$1 = cljs.core.next(seq52853);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52854,seq52853__$1);
}));
