...
return [(function (){var pred__42024 = cljs.core.instance_QMARK_;
var expr__42025 = reactive_val;
if(cljs.core.truth_((pred__42024.cljs$core$IFn$_invoke$arity$2 ? pred__42024.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42025) : pred__42024.call(null,reagent.ratom.RAtom,expr__42025)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42024.cljs$core$IFn$_invoke$arity$2 ? pred__42024.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42025) : pred__42024.call(null,reagent.ratom.RCursor,expr__42025)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42024.cljs$core$IFn$_invoke$arity$2 ? pred__42024.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42025) : pred__42024.call(null,reagent.ratom.Reaction,expr__42025)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42024.cljs$core$IFn$_invoke$arity$2 ? pred__42024.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42025) : pred__42024.call(null,reagent.ratom.Track,expr__42025)))){
return "tr";
} else {
return "other";
}
